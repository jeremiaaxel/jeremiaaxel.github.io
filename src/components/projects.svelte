<script lang="ts">
	...
	$: filteredProjects = (skillsFilter.size == 0) ? data : data.filter((project) => project.containsSkills([...skillsFilter]));
		...
		{#each uniquePriorities as priority}
			<div class="project-type">
				{#if sortedProjects[priority]}
					...
					<div class="project-item flex flex-col my-2" class:hidden={!filteredProjects.includes(project)}>
